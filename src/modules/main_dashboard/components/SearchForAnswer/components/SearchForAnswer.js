...
import { LinkAnswerCard } from '../../../../../stories/LinkAnswerCard/LinkAnswerCard';
...
const SearchForAnswer = withRouter(({ history }) => {
    ...
    <div className={classes.root} style={{ position: "relative" }}>
      ...
      <main className={classes.content}>
       ...
       />
         <Grid container spacing={0}>
                  <Grid item xs={12} >
                    <Paper style={{marginTop: '20px'}} className="req-answer-paper">
                      <span className="request-title">
                        What is track and trace?
                      </span>
                     
                          <p class="fade-text sub-card">
                            Sometimes you hear people say questions were "hard", which translated means
                            "they asked me stuff I don't know", or they asked me about stuff I've never even heard
                          </p>
