...
import { AskAnExpertFlatButton } from "../../../../../stories/LmAskAnExpertFlatButton/AskAnExpertFlatButton";
...
const SearchCards = withRouter(({ history }) => {
          ...
          <div className="main-content">
            ...
            >
              ...
              <Grid container item xs={6} md={9} lg={12}>
                <LmSearch
                  propsKeydown={(e) => getUpdatedValue(e)}
                  initInput={
