...
export const LmMoveDiscardModal = ({children
}) => {
  ...
  return (
    <div>
      ...
      <Box mt={2}/>
          <LmTypography variant="h6" style={{fontWeight: 'bold'}}>{"Are you sure you want to cancel before move the cards?"}
          </LmTypography>
          </DialogTitle>
        <Box pt={2} pb={5} px={2}>
        <DialogActions>
          <Button onClick={handleClose} color="secondary" variant="outlined">
            No, BACK TO MOVE CARDS
          </Button>
